/* ============================================================
   ...
   - Pour DRIVER : vérifie DRIVER
   - Ne remplace pas guard.js : il se branche AVANT guard.js
   ============================================================ */
  ...
  function guessPhone() {
    return cleanPhone(
      ...
      readStorage([
        ...
        "DIGIY_SESSION_PHONE",
        "DIGIY_DRIVER_PHONE",
        "DIGIY_DRIVER_SESSION_PHONE",
        "DIGIY_DRIVER_LAST_PHONE",
        "DIGIY_DRIVER_PRO_PHONE"
      ])
    );
  }
  ...
  function savePhone(phone, module) {
    ...
    try {
      ...
      if (m === "DRIVER") {
        ...
        localStorage.setItem("DIGIY_DRIVER_LAST_PHONE", p);
      }
    } catch (_) {}
  }
  ...
  function renderAccessBadge(target, result) {
    ...
    if (result.has_access) {
      ...
      el.innerHTML = `
        ...
        <small>PAY garde la preuve, ADMIN valide, puis DRIVER s’ouvre.</small>
      `;
    }
  }
